...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2ltbG5nbyIsImEiOiJjbTFsMTQ2azgwNDN0MmlxNnU2dzRuYnJoIn0.VAc7yYHOISXJxALkiEuMcQ';
...
var showAlert = exports.showAlert = function showAlert(type, msg) {
  var time_in_sec = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 7;
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>");
  document.querySelector('body').insertAdjacentHTML('afterbegin', markup);
  window.setTimeout(hideAlert, time_in_sec * 1000);
};
...
function _updateUserPassword() {
  _updateUserPassword = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(passwordCurrent, password, passwordConfirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 3:
          res = _context2.sent;
          if (res.data.statsus === SUCCESS) (0, _alert.showAlert)(SUCCESS, 'Password Update Successful!');
          _context2.next = 10;
          break;
        case 7:
          _context2.prev = 7;
...
if (userPasswordForm) {
  userPasswordForm.addEventListener(SUBMIT, /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var savePwBtn, passwordCurrent, password, passwordConfirm;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            ...
            //animation
            savePwBtn = document.getElementById('btn-save-password');
            savePwBtn.textContent = 'Updating...';
            passwordCurrent = document.getElementById('password-current').value;
            password = document.getElementById('password').value;
            passwordConfirm = document.getElementById('password-confirm').value;
            _context.next = 8;
            return (0, _updateData.updateUserPassword)(passwordCurrent, password, passwordConfirm);
          case 8:
            //clear the inputs
